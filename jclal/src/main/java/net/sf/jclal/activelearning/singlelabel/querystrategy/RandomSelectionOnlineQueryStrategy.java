 ...
 *
 */
public class RandomSelectionOnlineQueryStrategy extends AbstractSingleLabelOnlineQueryStrategy implements ITool {
     ...
     */
    public RandomSelectionOnlineQueryStrategy() {
    }
    ...
    public double utilityInstance(Instance instance) {
    	//System.out.println(randV[getUnlabelledData().getDataset().indexOf(instance)]);
