...
/**
 * Evaluation method used to analyze the performance of an experiment.
 *
...
public interface IEvaluationMethod {
    ...
    /**
     * Get the active learning algorithm used
     *
    ...
    /**
     * Set the active learning algorithm used
     * 
    ...
    /**
     * 
     * Get the final evaluations of the active learning process
     *
